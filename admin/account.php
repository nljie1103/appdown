...
<div class="card">
    <h3>账户信息</h3>
    <div class="form-row">
        <div class="form-group"><label>当前用户名</label><input type="text" class="form-control" id="currentUsername" readonly style="background:#f5f5f5;"></div>
...
<div class="card">
    ...
    <div class="form-row">
        ...
        <div class="form-group"><label>当前密码 <small style="color:var(--text-secondary);">验证身份</small></label><input type="password" class="form-control" id="usernameCurrentPwd" placeholder="输入当前密码以确认" autocomplete="current-password"></div>
    </div>
...
async function changeUsername() {
    ...
    try {
        await API.put('/admin/api/account.php', { action: 'username', new_username: newUsername, current_password: currentPwd });
