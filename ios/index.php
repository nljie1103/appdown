...
$siteName = htmlspecialchars($settings['site_title'] ?? '影视APP下载');
...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* 评分条 */
        .rating-bar { display: flex; align-items: center; gap: 12px; margin: 16px 0; }
        .stars { color: #ff9500; font-size: 0.9em; }
        .rating-score { font-size: 2em; font-weight: 700; color: #333; }
        ...
        .step-num {
            ...
            font-size: 0.85em; font-weight: 600; flex-shrink: 0;
        }
        ...
        .browser-tip-content {
            background: #fff; border-radius: 16px; padding: 30px; max-width: 300px; text-align: center;
        }
...
<?php if ($certName): ?>
        <div class="guide-card">
            ...
            <div class="step">
                ...
                <span class="step-text">请使用 <strong>Safari浏览器</strong> 打开此页面，点击上方「点击安装」</span>
            </div>
            <div class="step">
                <span class="step-num">2</span>
                <span class="step-text">弹窗提示中选择「安装」，返回桌面等待安装完成</span>
            </div>
            <div class="step">
                <span class="step-num">3</span>
                <span class="step-text">打开 <strong>设置 → 通用 → VPN与设备管理</strong></span>
            </div>
            <div class="step">
                <span class="step-num">4</span>
                <span class="step-text">找到 <span class="cert-name"><?= $certName ?></span> 并点击「信任」</span>
            </div>
            <div class="step">
                <span class="step-num">5</span>
                <span class="step-text">输入锁屏密码确认信任，即可正常使用</span>
            </div>
        </div>
<?php endif; ?>
        ...
        <div class="app-card">
            ...
            <ul class="info-list">
<?php if ($size): ?>
                <li><span>大小</span><span><?= $size ?></span></li>
<?php endif; ?>
<?php if ($version): ?>
                <li><span>版本</span><span><?= $version ?></span></li>
<?php endif; ?>
<?php if ($description): ?>
                <li><span>简介</span><span><?= $description ?></span></li>
<?php endif; ?>
...
<?php if ($certName): ?>
        <div class="faq-card">
            ...
            <div class="faq-item">
                <strong>Q: 提示"未受信任的开发者"？</strong>
                <p>进入「设置→通用→VPN与设备管理」→ 找到 <span class="cert-name"><?= $certName ?></span> → 点击信任</p>
            </div>
            <div class="faq-item">
                <strong>Q: 无法下载？</strong>
                <p>请关闭广告拦截插件，或确认使用Safari浏览器打开</p>
            </div>
            <div class="faq-item">
                <strong>Q: 安装后闪退？</strong>
                <p>重新信任证书，或卸载后重新安装</p>
            </div>
        </div>
<?php endif; ?>
