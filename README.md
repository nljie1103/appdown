...
租户 Admin 2.0 已覆盖真实业务能力：应用、iOS OTA、Mobileconfig、安装型下载、截图、附件、APK/IPA 包信息解析与 Builder、构建产物、Keystore、页面模板、内容组件、完整媒体库、TTF/OTF 字体名自动识别、站点设置、自定义代码、加密备份恢复、系统概览、Builder 自定义路径、Xcode 2FA 和账户安全。
